...
/* C:\laragon\www\cms/themes/makhweb/layouts/guest.htm */
class __TwigTemplate_6e6f842b4a4f06a1585519d351b36cfceccc73fc5bb2a0ca35f9b21228e0479b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body x-data=\"";
        // line 14
        ((($context["data"] ?? null)) ? (print (twig_escape_filter($this->env, json_encode(($context["data"] ?? null)), "html", null, true))) : (print ("{}")));
        echo "\">
        ...
        <!-- Content -->
        <section class=\"container mx-auto\" id=\"layout-content\">
            ";
        // line 23
    ...
    {
        return "C:\\laragon\\www\\cms/themes/makhweb/layouts/guest.htm";
    }
...
<html>
    ...
    <body x-data=\"{{ data ? (data | json_encode) :  \"{}\" }}\">
...
</html>", "C:\\laragon\\www\\cms/themes/makhweb/layouts/guest.htm", "");
    }
}
