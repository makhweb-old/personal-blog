...
class __TwigTemplate_2bda48f78c7511c88c95a373cc35b8e39dc65a152e3f42c4715c60e4ee101df2 extends \Twig\Template
{
    ...
    <div class=\"font-sans\">
        ...
        echo "\"
                                        :class=\"{ 'border-red-500': errors.name, 'border-grey-300': !errors.name }\"
                                        type=\"text\"
        ...
        // line 31
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["input"] ?? null), "username", [], "any", false, false, false, 31), "html", null, true);
        echo "\" type=\"text\"
        ...
        // line 43
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["input"] ?? null), "email", [], "any", false, false, false, 43), "html", null, true);
        echo "\" type=\"text\"
    ...
    {
        return array (  90 => 43,  75 => 31,  58 => 17,  51 => 13,  37 => 1,);
    }
                    ...
                    <div class=\"mt-6\">
                        ...
                        <form class=\"mt-8\" method=\"POST\" x-data=\"{ show: true, errors: {{ errors | json_encode }} }\">
                            <div class=\"mx-auto max-w-lg\">
                                <div class=\"py-2\">
                                    <span class=\"px-1 text-sm text-grey-600\">Full name</span>
                                    <input name=\"name\" placeholder=\"\" value=\"{{ input.name }}\"
                                        :class=\"{ 'border-red-500': errors.name, 'border-grey-300': !errors.name }\"
                                        type=\"text\"
                                        class=\"text-md block px-3 py-2  rounded-lg w-full 
                      bg-white border-2 placeholder-grey-600 shadow-md focus:placeholder-blue-500 focus:bg-white focus:border-blue-600 focus:outline-none\">
